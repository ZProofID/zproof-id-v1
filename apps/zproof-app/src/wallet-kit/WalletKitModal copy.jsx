  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`relative w-full max-w-xl overflow-hidden rounded-[2rem] border border-white/10 bg-[#080B18]/95 shadow-2xl shadow-blue-950/50 backdrop-blur transition-all duration-300 ease-out ${
          isVisible
      ...
      >
        ...
        <div className="p-6 sm:p-7">
          ...
          <div className="mt-6 rounded-2xl border border-blue-400/20 bg-blue-500/10 p-4">
            ...
            {/* <p className="mt-2 text-sm leading-6 text-slate-400">
              ZProof.ID uses your wallet to sign verification actions. Your
